#ifndef PAIRWISE_INCREMENTAL_REGISTRATION_H
#define PAIRWISE_INCREMENTAL_REGISTRATION_H
...
namespace pairwise_incremental_registration
{

class PairwiseIncrementalRegistration
{
public:
...
#endif // PAIRWISE_INCREMENTAL_REGISTRATION_H
